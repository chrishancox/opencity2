/***************************************************************************
                      agentposition.h  -  description
							-------------------
	begin                : may 1st, 2008
	copyright            : (C) 2008-2010 by Duong Khang NGUYEN
	email                : neoneurone @ gmail com

	$Id: agentposition.h 448 2010-05-09 15:18:32Z neoneurone $
 ***************************************************************************/
...
#ifndef _OPENCITY_MAS_AGENTPOSITION_H_
#define _OPENCITY_MAS_AGENTPOSITION_H_ 1
